...
import {
    configurePossumStore,
    getFailedRequests,
    PossumStoreConfigOptions,
    removeFailedRequest,
    storeFailedRequest
} from "./storage";
 ...
 */
async function performPossumRequest(request: PossumRequest): Promise<any> {
    try {
 ...
 */
function processFailedRequestsOnLoad(): void {
